  ...
  try {
    ...
    await sendEmail({
      ...
      html: `
                ...
                <a href="https://chat-application-1-0mdx.onrender.com/api/auth/verify-email?token=${emailVerificationToken}">Verify Email</a>
    ...
    if (user.isVerified) {
      ...
      await sendEmail({
        ...
        html: `
                ...
                <p>Thank you for registering at <strong>Perplexity</strong>. We're excited to have you on board!</p>
                <p>Please verify your email address by clicking the link below:</p>
                <a href="https://chat-application-1-0mdx.onrender.com/api/auth/verify-email?token=${token}">Verify Email</a>
                <p>If you did not create an account, please ignore this email.</p>
                <p>Best regards,<br>The Perplexity Team</p>
        `,
      });
